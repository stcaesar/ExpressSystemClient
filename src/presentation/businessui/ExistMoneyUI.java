...
public class ExistMoneyUI extends JPanel{
	...
	public ExistMoneyUI (){
		...
		a.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
    			...
    			String readState = "unchecked";
			     MainFrame.setContentPanel(new Table4(barCode,readState));
    		}
    	});
		...
		b.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
    			...
    			String barCode = ta.getText().trim();
    			if(business.deleteBusinessVouicher(barCode)){
    			//SuccessUI success = new SuccessUI();
    				MainFrame.showmessage("操作成功");
    			}
    	    }
    	});
